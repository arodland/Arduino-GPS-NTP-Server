...
LIB_SRC       = $(wildcard $(patsubst %,%/*.cpp,$(SYS_LIBS)) $(patsubst %,%/*.c,$(SYS_LIBS)))
LIB_OBJS      = $(filter %.o, $(foreach LPATH, $(ARDUINO_LIB_PATH), $(patsubst $(LPATH)/%.cpp,$(OBJDIR)/libs/%.o,$(patsubst $(LPATH)/%.c,$(OBJDIR)/libs/%.o,$(LIB_SRC)))))

CPPFLAGS      = -mmcu=$(MCU) -DF_CPU=$(F_CPU) -DARDUINO=20 \
